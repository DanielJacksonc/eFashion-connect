...
<head>
    ...
    <title>e-fashion Customer</title>
            ...
            <div class="main-nav">
                            ...
                            <nav class="navbar navbar-expand-lg nav-white nav-primary-hover">
                                ...
                                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                    <ul class="navbar-nav">
                                        ...
                                        <li class="nav-item"><a class="nav-link" href="<?php echo base_url('b/balance'); ?>">Balance</a></li>
                                        <li class="nav-item"><a class="nav-link" href="<?php echo base_url('b/orders'); ?>">Orders</a></li>
                                        <li class="nav-item"><a class="nav-link" href="<?php echo base_url('b/orders_request'); ?>">Order Request</a></li>
                ...
                <div class="position-absolute nav-right-side d-lg-flex align-items-center d-none">
                    <nav class="navbar navbar-expand-lg nav-dark">
                        <ul class="navbar-nav">
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo base_url('b/inbox'); ?>">Inbox</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo base_url('b/setting'); ?>">Settings</a>
                            </li>
                        </ul>
                    </nav>
                    <div class="d-flex">
